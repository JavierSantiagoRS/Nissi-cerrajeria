...
include '../../controlador/pendientes_c.php';

$ventas = obtenerVentasPendientes($conn);

$sql_ventas_pendientes = "SELECT COUNT(*) AS total FROM ventas WHERE estado = 'pendiente'";
$total_ventas = $conn->query($sql_ventas_pendientes)->fetch_assoc()['total'];
 ...
 <li><a href="servicio_v.php"><i class="fas fa-tools"></i> servicios</a></li>
  <li><a href="pedido_v.php"><i class="fas fa-tools"></i>Pedidos</a></li>
    <li > <a href="venta_v.php"><i class="fas fa-tools"></i>Ventas</a></li>
     <li class="active"> <a href="pendientes_v.php"><i class="fas fa-tools"></i>Ventas Pendientes</a></li>
